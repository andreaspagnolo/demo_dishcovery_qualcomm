...
No original console log was retained. This command is reconstructed from the complete archived JSON settings and describes the historical W4A16 run. The current runner defaults to W8A16.
...
The archived result is `eval_first_350_samples.json`; it is retained as historical evidence, not the current acceptance target.
